...
if(loading) {
    ...
    return (
      ...
      <section className="bg-black flex flex-col justify-center items-center pt-48" >
          ...
          {
          movies && <div className={isAddedByMe ? "bg-yellow-500 flex flex-col justify-center items-center w-[500px]" : "bg-red-500  flex flex-col justify-center items-center w-[500px]"}>
                      <h2 className="text-2xl my-2">{movies.title}</h2>
                      <img className="w-[200px] mb-1" src={movies.img} alt="" />
                      <p className="mb-1">Hlavní herci: {movies.actors}</p>
                      <p className="mb-1">Rok natočení: {movies.year}</p>
                      <p className="mb-1">Žánr: {movies.genre}</p>
                      <p className="mb-1">Délka filmu: {movies.time} minut</p>
                      <p className="mb-1">Přidal: {movies.addedBy}</p>
                      <div className="flex flex-row space-x-2 my-2">
                        <Link className="bg-black p-2 rounded mb-2 hover:bg-gray-600" to="/movielist">Zpět</Link>
                        <button className="bg-black p-2 rounded mb-2 hover:bg-gray-600" onClick={ () => {handleDelete(id)}}>Smazat</button>
                      </div>
                    </div>
        }
      </section>
